...
JNIEXPORT jint JNICALL Java_org_araqne_winapi_RegistryKey_RegOpenKeyEx
...
JNIEXPORT jint JNICALL Java_org_araqne_winapi_RegistryKey_RegQueryValueEx
...
JNIEXPORT jint JNICALL Java_org_araqne_winapi_RegistryKey_RegCloseKey
  (JNIEnv *env, jobject obj, jint hkey)
{
	return RegCloseKey((HKEY)hkey);
}

JNIEXPORT jint JNICALL Java_org_araqne_winapi_RegistryKey_RegQueryInfoKey
...
JNIEXPORT jint JNICALL Java_org_araqne_winapi_RegistryKey_RegEnumKeyEx
...
JNIEXPORT jint JNICALL Java_org_araqne_winapi_RegistryKey_RegEnumValue
